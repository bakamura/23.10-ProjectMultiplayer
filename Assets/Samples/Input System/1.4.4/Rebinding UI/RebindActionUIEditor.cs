...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            m_actionOverrideStringProprety = serializedObject.FindProperty("m_ActionLabelString");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.LabelField(m_CustomizeUI, Styles.boldLabel);
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(m_actionOverrideProperty);
                if(m_RebindActionUI.m_OverrideActionLabel)EditorGUILayout.PropertyField(m_actionOverrideStringProprety);
            }
        ...
        private SerializedProperty m_actionOverrideStringProprety;
